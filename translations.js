...
window.translations = {
  sv: {
    ...
    projects: {
      ...
      otherHeading: 'Andra intressanta projekt',
      sdgOots: 'Systemutvecklare, testare och Scrum Master i EU-projektet SDG OOTS för automatiserat bevisutbyte mellan EU-länder. Utveckling av mikrotjänster i säkerhetsklassad miljö med fokus på testautomatisering och kvalitetssäkring.',
      teliaC2b: 'Utveckling av mikrotjänster och integrationer hos Telia Company med fokus på CI/CD-pipelines, DevOps-processer och containerisering i en storskalig telekommiljö.',
      teliaEnableZone: 'Utveckling av serverlösa AWS Lambda-funktioner och en React-frontend för mikrotjänster hos Telia, med fokus på molnarkitektur och moderna webbteknologier.',
      ootsCodelist: 'En kodlistetjänst för SDG OOTS-projektet som hanterar och tillhandahåller standardiserade kodlistor för bevisutbyte mellan EU-medlemsstater.',
      ootsRequester: 'En requester-komponent i SDG OOTS-ekosystemet som hanterar förfrågningar om bevisutbyte mellan EU-länders myndigheter.',
      goECharger: 'En Home Assistant-automation som dynamiskt justerar laddströmmen för en go-eCharger baserat på husets fasströmmar för att undvika att huvudsäkringen löser ut.'
    },
    hero: {
    ...
    footer: {
      ...
      designed: 'Designad & byggd av Nicklas'
    },
    about: {
  ...
  en: {
    ...
    projects: {
      ...
      sdgOots: 'Systems developer, tester and Scrum Master in the EU project SDG OOTS for automated evidence exchange between EU countries. Development of microservices in a security-classified environment focusing on test automation and quality assurance.',
      teliaC2b: 'Development of microservices and integrations at Telia Company focusing on CI/CD pipelines, DevOps processes and containerization in a large-scale telecom environment.',
      teliaEnableZone: 'Development of serverless AWS Lambda functions and a React frontend for microservices at Telia, focusing on cloud architecture and modern web technologies.',
      ootsCodelist: 'A codelist service for the SDG OOTS project that manages and provides standardized codelists for evidence exchange between EU member states.',
      ootsRequester: 'A requester component in the SDG OOTS ecosystem that handles requests for evidence exchange between EU member state authorities.',
      goECharger: 'A Home Assistant automation that dynamically adjusts charging current for a go-eCharger based on household phase currents to prevent the main circuit breaker from tripping.'
    },
    hero: {
    ...
    footer: {
      ...
      designed: 'Designed & Built by Nicklas'
    },
    about: {
